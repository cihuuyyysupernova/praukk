...
<div class="container mx-auto">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Siswa Dashboard</h1>
    
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="text-2xl font-bold text-blue-600">{{ $myReports }}</div>
            <div class="text-gray-600">Total Laporan Saya</div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Laporan Saya</h2>
                            ...
                            @foreach($recentReports as $report)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('siswa.reports.show', $report) }}" class="text-indigo-600 hover:text-indigo-900">Lihat</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
